...
my_list = [random.randint(1, 20) for _ in range(int(input('Вводим количество кустов: ')))]
print(my_list)

bush_number = int(input(' Вводим номер куста: '))

result = 0
if bush_number == 1:
    result = my_list[0] + my_list[1] + my_list[-1]
elif bush_number == len(my_list):
    result = my_list[-2] + my_list[-1] + my_list[0]
else:
    result = my_list[bush_number] + my_list[bush_number - 1] + my_list[bush_number - 2]
print(f'Максимальное количество ягод {result}')